...
genre_colors <- c(
  "Action"           = "#99000d",  # Deep Red
  "Adventure"        = "#cb181d",  # Red
  "Animation"        = "#ef3b2c",  # Bright Red
  "Comedy"           = "#fb6a4a",  # Light Red
  "Crime"            = "#fc9272",  # Salmon
  "Documentary"      = "#fcbba1",  # Light Salmon
  "Drama"            = "#fed976",  # Light Yellow-Orange
  "Family"           = "#feb24c",  # Orange
  "Fantasy"          = "#fd8d3c",  # Deep Orange
  "Foreign"          = "#fc4e2a",  # Red-Orange
  "History"          = "#e6550d",  # Burnt Orange
  "Horror"           = "#d94701",  # Rust Orange
  "Music"            = "#dd3497",  # Reddish Pink
  "Mystery"          = "#c51b8a",  # Magenta
  "Romance"          = "#ae017e",  # Dark Magenta
  "Science Fiction"  = "#9e0168",  # Purple-Pink
  "Thriller"         = "#7a0177",  # Violet
  "TV Movie"         = "#54278f",  # Deep Purple
  "War"              = "#3f007d",  # Indigo
  "Western"          = "#2a115d"   # Near Black Purple
)
                  ...
                  div(style = "height: 85vh; display: flex; flex-direction: column;",
                      fluidRow(
                        box(
                          ...
                          withSpinner(networkD3::forceNetworkOutput("collaboration_network", height = "35vh"))
                        )
                      ),
                      fluidRow(
                        box(
              ...
              fluidRow(
                box(
                  ...
                  tags$div(
                    ...
                    p("Keep in mind that movies available in this dashboard are only up to 2016."),
